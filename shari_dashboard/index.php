...
if (isset($_POST['btnShutDown']))
    {
        ...
        //$password = $_POST['password'];
        //exec('nmcli dev wifi rescan');
        $command = "sudo shutdown now 2>&1";
        exec($command,$screen,$retval);
}

if (isset($_POST['btnPIRestart']))
    {
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"> 
	...
	<button name="btnSVXRESTART" type="submit" class="red" style = "height:30px; width:100px; font-size:12px;">Restart SVX</button>
	<button name="btnShutDown" type="submit" class="red" style = "height:30px; width:100px; font-size:12px;">PI Shutdown</button>
	<button name="btnPIRestart" type="submit" class="red" style = "height:30px; width:100px; font-size:12px;">PI Restart</button>
